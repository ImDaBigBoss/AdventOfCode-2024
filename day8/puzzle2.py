    ...
    for frequency in antenna_freq_positions:
        ...
        for position in antenna_positions:
            ...
            for other_position in other_positions:
                # Calculate the relative antinode direction
                antinode_direction = position.diff(other_position)
                multiplier = 0

                while True:
                    # Calculate the relative antinode position with the specified multiplier
                    antinode = antinode_direction.copy().mul(multiplier)
